...
import acosta_bonafede_spadola_unzaga.Service.FamiliaService;
import jakarta.validation.Valid;

@Controller
@RequestMapping("/Asistidos")
public class ControllerAsistidosCRUD {
...
private BeansAsistidos formBean;
...
public String guardarFamilia(@Valid @ModelAttribute(FORM_BEAN) BeansAsistidos formBean,
...
public String ActualizarFamilia(@Valid @ModelAttribute(FORM_BEAN) BeansAsistidos formBean,
                            BindingResult bindingResult,
                            Model modelo,
                            RedirectAttributes redirectAttributes,
                            @RequestParam String action) throws CheckedException {
