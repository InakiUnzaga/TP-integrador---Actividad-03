...
public class BeansPersonas {
   ...
   @PastOrPresent(message = "La fecha de nacimiento no puede ser posterior a la fecha actual.") 
    ...
    public BeansPersonas() {}

    public BeansPersonas(String apellido, String nombre, String direccion, Long dni, LocalDate fechaNacimiento, String ocupacion) {
